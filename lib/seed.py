...
botw=Game(title="Breath of the wind", platform="Switch", genre="Adventure", price=60)
...
mk7=Game(title="Candy Crush Saga", platform="Mobile", genre="Puzzle", price=0)

session.bulk_save_objects([botw, ffvii, mk8, mk7])
session.commit()
